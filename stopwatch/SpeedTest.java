...
public class SpeedTest {
	...
	/**
	 * add double primitives from an array. You need a large counter
	...
	public static void testSumDoublePrimitive(int counter) {
		...
		timer.start();
		double sum = 0.0;
		// count is a loop counter, i = array index value
	...
	/**
	 * add Double objects from an array. You need a large counter value
	...
	/**
	 * add BigDecimal objects from an array. You need a large counter
	 * value to get a measurable time.
	 */
